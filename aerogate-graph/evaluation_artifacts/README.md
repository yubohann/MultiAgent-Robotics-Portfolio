...
- `reproducibility.md` documents environment, commands, seeds, expected outputs, tests, and hash checks.
...
- `results_manifest.json` lists source path, purpose, size, and SHA256 for each retained artifact.
