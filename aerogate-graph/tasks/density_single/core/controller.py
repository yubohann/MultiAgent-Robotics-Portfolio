...
from tasks.density_single.core.action_shield import apply_action_shield
...
from tasks.density_single.core.gate_layout import _moving_gate_centers, _moving_gate_swept_clearance_m
...
class GateDensityController:
    ...
    def _plan(self) -> None:
        from tasks.multi.configs.experiment_config import MultiPlannerConfig
        from tasks.multi.planners.global_route_planner import GlobalRoutePlanner2D
