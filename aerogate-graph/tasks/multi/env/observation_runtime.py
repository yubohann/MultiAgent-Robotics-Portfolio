"""Observation assembly helpers for ``MultiGate2DEnv``."""
...
from tasks.multi.env.observation_multi import build_multi_graph_observation


class ObservationRuntimeMixin:
    """Observation assembly for the graph policy."""
    ...
    def _dynamic_gate_observation_feedforward_speed_mps(
        ...
        *,
        ...
        if min_clearance_m < 0.75:
            ...
            desired_speed *= 0.9
        if self._step_count < 10 and num_agents >= 24:
            desired_speed *= 0.7
