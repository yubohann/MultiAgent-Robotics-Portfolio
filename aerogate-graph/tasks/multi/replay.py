...
from tasks.multi.dynamic_gate_task_slots import dynamic_gate_task_first_slots
...
def render_multi_replay_isaaclab_from_summary(
    *,
    ...
    from tasks.multi.configs import infer_multi_config_name_from_experiment_id
    ...
    command = [
        sys.executable,
        "-m",
        "tasks.multi.scripts.replay_multi_isaaclab",
        "--trajectory",
        trajectory_path,
        "--report",
        report_path,
