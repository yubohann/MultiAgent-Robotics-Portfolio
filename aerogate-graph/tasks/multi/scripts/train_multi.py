"""Minimal training entry for the multi-agent Graph-FlashSAC experiment."""
...
def main() -> None:
    ...
    from tasks.multi.configs import get_multi_experiment_config, list_multi_experiment_config_names
    from tasks.multi.training import run_training

    parser = argparse.ArgumentParser(description="Train the multi-agent Graph-FlashSAC gate experiment.")
    ...
    parser.add_argument("--live-preview-isaaclab", action="store_true")
    parser.add_argument("--live-preview-interval-steps", type=int, default=0)
    parser.add_argument("--live-preview-follow-agent-index", type=int, default=0)
    ...
    summary = run_training(
        ...
        live_preview_isaaclab=args.live_preview_isaaclab,
        live_preview_interval_steps=args.live_preview_interval_steps,
        live_preview_follow_agent_index=args.live_preview_follow_agent_index,
    )
    print(f"runtime_policy={RUNTIME_POLICY}")
    print(f"config_name={args.config_name}")
    print("multi-agent Graph-FlashSAC training complete")
