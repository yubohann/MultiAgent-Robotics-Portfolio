...
def main() -> None:
    ...
    from tasks.multi.dagger import run_dagger_warmstart_then_finetune
    from tasks.multi.imitation import run_bc_warmstart_then_finetune
    from tasks.multi.sanity import assert_dynamic_gate_density_environment_sane
    from tasks.multi.training import evaluate_checkpoint, run_training
    ...
    train_device = str(args.train_device or "cuda")
