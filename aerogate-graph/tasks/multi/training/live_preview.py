...
from tasks.multi.configs.experiment_config import MultiExperimentConfig, is_exp3_kinematic_3d_scene_mode
...
def _start_live_isaaclab_preview(
    *,
    ...
    command = [
        sys.executable,
        "-m",
        "tasks.multi.scripts.live_preview_multi_isaaclab",
        "--snapshot",
        str(snapshot_path),
        "--config-name",
