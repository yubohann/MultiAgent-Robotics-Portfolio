"""Stage-D config entry for the multi-agent gate_graph_2d_minimal experiment."""
...
class MultiSceneConfig:
    ...
    drone_asset: str = "five_in_drone.usd"
...
def build_dynamic_gate_density_8d_config() -> MultiExperimentConfig:
    ...
    from shared.runtime.formation_demo import (
