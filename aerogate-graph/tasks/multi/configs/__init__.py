...
from tasks.multi.configs.experiment_config_fixed_02 import (
    MULTI_EXPERIMENT_CONFIG as FIXED_MULTI_EXPERIMENT_CONFIG_02,
)
from tasks.multi.configs.experiment_config_fixed_03 import (
    MULTI_EXPERIMENT_CONFIG as FIXED_MULTI_EXPERIMENT_CONFIG_03,
)
from tasks.multi.configs.experiment_config_fixed_05 import (
    MULTI_EXPERIMENT_CONFIG as FIXED_MULTI_EXPERIMENT_CONFIG_05,
)
from tasks.multi.configs.experiment_config_fixed_07 import (
    MULTI_EXPERIMENT_CONFIG as FIXED_MULTI_EXPERIMENT_CONFIG_07,
)
from tasks.multi.configs.experiment_config_fixed_08 import (
    MULTI_EXPERIMENT_CONFIG as FIXED_MULTI_EXPERIMENT_CONFIG_08,
)
from tasks.multi.configs.experiment_config_fixed_09 import (
    MULTI_EXPERIMENT_CONFIG as FIXED_MULTI_EXPERIMENT_CONFIG_09,
)
from tasks.multi.configs.experiment_config_fixed_12 import (
    MULTI_EXPERIMENT_CONFIG as FIXED_MULTI_EXPERIMENT_CONFIG_12,
)
