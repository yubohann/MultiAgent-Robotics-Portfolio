...
These docs explain what the benchmark does, how the data is captured and audited, and how to extend the pipeline. They serve researchers who run the pipeline, read the data, or extend the benchmark.
...
| [Scoring](evaluation.md) | How episodes are scored and how submissions work |
...
| [Determinism](reproducibility.md) | Same-seed runs, runtime locks, and clean-room replay |
