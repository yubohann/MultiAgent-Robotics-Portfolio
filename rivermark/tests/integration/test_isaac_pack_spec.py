...
from rivermark_benchmark.pack.isaac_pack import validate_isaac_pack_spec
from rivermark_benchmark.pack.isaac_pack_descriptor import build_isaac_observation_abi
from rivermark_benchmark.pack.isaac_pack_spec import (
    IsaacPackSpecError,
...
def test_writer_is_atomic_and_refuses_overwrite() -> None:
    ...
    with tempfile.TemporaryDirectory() as temporary:
        ...
        with patch(
            "rivermark_benchmark.pack.isaac_pack_spec.pack_spec_for_capture",
