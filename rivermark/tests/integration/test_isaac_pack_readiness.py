...
from rivermark_benchmark.audit.formal_dataset import identity_file
from rivermark_benchmark.data.abi import observation_abi_identity
from rivermark_benchmark.data.policy_projection import (
    PolicyProjectionError,
    PolicySourceInspection,
    inspect_candidate_pack_streams,
)
from rivermark_benchmark.pack.isaac_pack import PACK_SPEC_SCHEMA, PACK_SPEC_SCHEMA_V2
from rivermark_benchmark.pack.isaac_pack_readiness import audit_isaac_pack_readiness
...
class IsaacPackReadinessTests(unittest.TestCase):
    def test_external_v2_abi_is_identity_and_capture_bound_without_mutating_capture(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            with patch(
                "rivermark_benchmark.pack.isaac_pack_readiness.inspect_policy_observation_sources",
