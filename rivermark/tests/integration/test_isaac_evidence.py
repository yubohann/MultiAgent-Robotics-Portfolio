...
from rivermark_benchmark.isaac.isaac_evidence import (
    EVIDENCE_MANIFEST_SCHEMA,
    EVIDENCE_RECEIPT_SCHEMA,
    pack_isaac_development_evidence,
)
from rivermark_benchmark.ops.video import (
...
class IsaacDevelopmentEvidenceTests(unittest.TestCase):
    def _pack(self, capture: Path, validation: Path, destination: Path, videos: list[Path]):
        with patch("rivermark_benchmark.isaac.isaac_evidence.audit_video", side_effect=_audit), patch(
            "rivermark_benchmark.isaac.isaac_evidence.require_release_video"
        ):
