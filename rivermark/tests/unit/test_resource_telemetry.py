...
from rivermark_benchmark.runtime.resource_telemetry import (
...
class ResourceTelemetryTests(unittest.TestCase):
    ...
    def test_windows_private_commit_has_a_distinct_semantic_field(self) -> None:
        telemetry = ResourceTelemetry()
        with mock.patch(
            "rivermark_benchmark.runtime.resource_telemetry._process_memory_snapshot",
            return_value={
    ...
    def test_commit_attribution_is_aggregate_and_does_not_require_process_identity(self) -> None:
        ...
        with mock.patch(
            ...
            "rivermark_benchmark.runtime.resource_telemetry._system_commit_snapshot",
            return_value={
    ...
    def test_foreign_native_census_excludes_owned_kit_child_but_not_foreign_owner(self) -> None:
        ...
        with mock.patch(
            "rivermark_benchmark.runtime.resource_telemetry._windows_native_process_rows",
            return_value=rows,
        ), mock.patch(
            "rivermark_benchmark.runtime.resource_telemetry._windows_owned_process_ids",
