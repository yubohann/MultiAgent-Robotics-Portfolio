...
import rivermark_benchmark.audit.cohort_audit as cohort_audit_module
from rivermark_benchmark._identity import IdentityAccumulator
from rivermark_benchmark.audit.cohort_audit import (
    COHORT_AUDIT_SCHEMA,
    CohortAuditError,
...
from rivermark_benchmark.runtime.failure_ledger import FailureRecord
...
def test_cohort_audit_binds_eight_candidates_to_eleven_attempts(tmp_path: Path) -> None:
    ...
    assert report["audit_provenance"] == {
        "analyzer_module": "rivermark_benchmark.audit.cohort_audit",
