...
from rivermark_benchmark.audit.formal_dataset import rebuild_dataset_index
from rivermark_benchmark.audit.release_readiness import audit_release_readiness
...
class ReleaseReadinessTests(unittest.TestCase):
    ...
    def test_local_payload_identity_and_bindings_are_checked(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            with patch("rivermark_benchmark.audit.release_readiness.verify_dataset_integrity", return_value=integrity), \
                patch("rivermark_benchmark.audit.release_readiness.load_release_manifest", return_value=release), \
                patch("rivermark_benchmark.audit.release_readiness.verify_supply_chain_manifest", return_value=supply):
