...
from ..citylite_scene.citylite_task import (
    LIDAR_CHANNEL_COUNT,
...
from ..citylite_scene.condition_realization import condition_request_from_protocol
...
from ..data.frame_archive import FrameSpool, write_chunked_frame_archive
from ..ops.cleanup_history import cleanup_completed_runs
...
from ..score.private_evaluator_manifest import (
...
from ..train.isaac_transfer import FixedDecisionCadence, WorldCommandBounds
...
def _bind_runtime_lock_to_args(
    ...
    if args.runtime_lock is None:
        return None
    from ..runtime.runtime_lock import load_runtime_lock, runtime_lock_identity
...
def _create_state_only_sb3_transfer(args: argparse.Namespace) -> Any:
    ...
    from ..train.isaac_transfer import (
...
def _load_native_t2_calibration_binding(
    ...
    *,
    ...
    from ..runtime.runtime_lock import runtime_lock_identity
...
def _run_capture_preflight(
    ...
    from ..runtime.preflight import RuntimePreflightRequirements, run_preflight
...
def _capture(
    ...
    lease = repository_app_launcher_lease(
        ...
        metadata={
            ...
            "owner": "rivermark_benchmark.isaac.isaac_capture",
        },
    )
    ...
    try:
        ...
        if runtime_lock is not None:
            from ..runtime.runtime_lock import (
        ...
        if runtime_lock is not None:
            from ..runtime.runtime_lock import configure_simulation_cfg
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    receipt: dict[str, Any] = {
        ...
        "provenance": {
            "capture_owner": "rivermark_benchmark.isaac.isaac_capture",
