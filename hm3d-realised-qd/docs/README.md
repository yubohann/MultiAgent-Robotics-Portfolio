...
| 从这里开始 | 文档 |
|---|---|
| 组件级结果表，基线对照与机制消融，2026-08-08 | [P10 主表结果](p10-main-results-2026-08-08.md) |
| 论文级冻结记录，主张，实验体系与数据规模 | [论文实验结果汇总](experiment-results-2026-08-08.md) |
| realised-QD，RB-SF-SAC 与 RFG 的方法合同与差距清单 | [主方法严格设计](method-design-realised-qd-rfg-rb-sf-sac-2026-08-08.md) |

## 目录范围

```text
src/realised_qd/      contracts, adapters, realised-QD, RL, runtime, safety, scoring
configs/              HM3D protocols, experiment manifests and external-method contracts
scripts/              geometry, exploration, mechanism and formal phase groups, baseline and audit scripts, Isaac launch wrappers
