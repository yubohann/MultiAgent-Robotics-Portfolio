...
from realised_qd.contracts.exploration import (
    AgentExecutionOutcome,
    AgentExplorationPlan,
    ExplorationExecutionOutcome,
    TeamExplorationCandidate,
)
from realised_qd.evaluation.hm3d_exploration import (
...
def test_evaluator_denominator_digest_binds_geometry_geometry_but_not_row_order():
    first = {
        "scene_id": "scene-a",
