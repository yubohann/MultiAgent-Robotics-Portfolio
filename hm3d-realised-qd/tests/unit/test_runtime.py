...
from realised_qd.adapters.hm3d_runtime import (
...
def test_official_example_is_engineering_only(tmp_path: Path) -> None:
    ...
    assert audit["formal_freeze_authorized"] is False
...
def test_formal_scope_needs_all_three_splits() -> None:
    ...
    assert audit_asset_scope(rows)["formal_freeze_authorized"] is False
