...
from realised_qd.contracts.models import CandidateFragmentManifest, PublicMethodContext
from realised_qd.runtime.hm3d_realised_qd import audit_public_candidate_intent_richness
...
def test_retired_public_baseline_selectors_fail_closed(strategy: str) -> None:
    """Removed legacy branches cannot silently re-enter a Exploration comparison."""
...
def test_frontier_3d_prefers_region_access_over_slightly_higher_local_gain() -> None:
    from realised_qd.contracts.models import FragmentInstance, FragmentTypeSignature
    state = _state()
