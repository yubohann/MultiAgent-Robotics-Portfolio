...
def _state() -> PublicSearchState:
    context = PublicMethodContext(
        context_id="exploration-single-rl-context",
        episode_id="exploration-single-rl-episode",
...
def test_single_rl_checkpoint_schema_is_explicit():
    assert SINGLE_RL_CHECKPOINT_SCHEMA_VERSION == "hm3d-single-rl-checkpoint-v2"
