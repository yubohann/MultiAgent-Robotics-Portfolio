"""Select evaluator-only sparse-range receiver positions from admitted geometry."""
...
from realised_qd.runtime.hm3d_calibration_geometry import farthest_spread_indices
...
def main() -> int:
    ...
    if _flight_space_file_id(rebuilt_flight) != expected_flight_id:
        raise ValueError("rebuilt ESDF differs from frozen Geometry flight-space audit")
