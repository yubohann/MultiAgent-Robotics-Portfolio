...
def audit_formal_matrix_admission(
    formal_freeze: dict[str, Any],
    baseline_matrix: dict[str, Any],
    metric_registry: dict[str, Any],
    runtime_evidence: dict[str, Any],
) -> dict[str, Any]:
    reasons: list[str] = []
    if formal_freeze.get("status") != "FORMAL_PROTOCOL_FROZEN":
        reasons.append("FORMAL_PROTOCOL_NOT_FROZEN")
    ...
    return {
        ...
        "reasons": reasons,
        "formal_freeze_id": payload_label(formal_freeze, prefix="formal-freeze"),
...
def main() -> int:
    ...
    parser.add_argument("--formal-freeze", required=True, type=Path)
    ...
    payload = audit_formal_matrix_admission(
        read_json_object(args.formal_freeze),
