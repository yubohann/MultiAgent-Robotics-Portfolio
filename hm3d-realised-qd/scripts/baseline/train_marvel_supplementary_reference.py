"""Train the outcome-backed MARVEL author-network discrete SAC baseline."""
...
from realised_qd.contracts.io import read_json_object, write_json_atomic
...
def main() -> int:
    ...
    samples = tuple(
        ...
        for sample in sample_from_exploration_training_record(
            read_json_object(path.expanduser().resolve()), allowed_train_scene_ids=train_scenes
        )
    )
    ...
    print(
        "MARVEL_SUPPLEMENTARY_REFERENCE_TRAINING_COMPLETE "
