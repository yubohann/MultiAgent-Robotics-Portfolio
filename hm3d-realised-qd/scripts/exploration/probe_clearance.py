...
from realised_qd.evaluation.hm3d_safety import ConservativeVoxelClearance
...
def main() -> int:
    ...
    payload: dict[str, object] = {
        "schema_version": "hm3d-clearance-probe-v1",
        "status": "ENGINEERING_DIAGNOSTIC_NOT_EXPLORATION_RESULT",
        "claim_limit": (
