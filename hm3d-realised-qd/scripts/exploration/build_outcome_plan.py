"""Build a fresh-process Exploration train-outcome collection plan."""
...
from realised_qd.contracts.io import write_json_atomic  # noqa: E402
...
def main() -> int:
            ...
            runs.append(
                {
                    ...
                    "runner_arguments": [
                        ...
                        "--geometry-artifact", _as_posix(args.geometry_artifact),
    ...
    payload = {
        ...
        "claim_limit": (
            "Development train-only Exploration outcome collection on the frozen scene "
