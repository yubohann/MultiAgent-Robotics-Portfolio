...
Isaac 与 PhysX 运行通过 `scripts/run_isaac_python.ps1` 启动，需要已验证的 IsaacLab 解释器，并设置 `AEROCITY_CF2X_USD` 指向本地 CF2X USD 资产。公开源码树只包含代码，合同与文档。HM3D 资产，转换网格，检查点与原始运行输出保存在本地工作区。

## 文档

- [文档索引](docs/README.md)，当前设计，结果与研究记录集合。
- [主方法严格设计](docs/主方法严格设计_realised_QD_RFG_RB_SF_SAC_2026-08-08.md)，realised-QD，RB-SF-SAC 与 RFG 的方法合同。
- [P10 主表结果](docs/P10主表结果_2026-08-08.md)，组件级结果表与消融。
- [论文实验结果汇总](docs/论文实验结果汇总_2026-08-08.md)，上述数字背后的冻结研究记录。
