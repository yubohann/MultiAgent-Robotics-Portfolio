...
from realised_qd.archives.qd import (
    AdmissionDecision,
    ArchiveSpec,
    DescriptorAxis,
    Elite,
...
from realised_qd.runtime.hm3d_belief import PublicRangeRayOutcome, SparseVoxelBelief
...
# Accountability check on a selected QD intervention, not a task threshold; the Mechanism
...
def qd_selector_backbone_id(*, utility_slack: float) -> str:
    """Identify the common public value layer shared by all three Mechanism QD controls."""
