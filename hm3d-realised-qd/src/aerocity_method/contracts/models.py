...
from aerocity_method.contracts.io import finite_number, require_identifier, to_primitive
...
class FragmentInstance:
    ...
    def __post_init__(self) -> None:
        ...
        elif any(value is not None for value in (self.sender_id, self.receiver_id, self.message_id)):
