...
#include "interfaces/msg/target_detection.hpp"
...
public:
  ...
  : Node("competition_behavior")
  {
    ...
    detection_sub_ = create_subscription<interfaces::msg::TargetDetection>(
      target_detection_topic_, 10,
      [this](const interfaces::msg::TargetDetection::SharedPtr msg) {
        last_detection_ = *msg;
...
private:
  ...
  bool is_own_detection(const interfaces::msg::TargetDetection & detection) const
  {
  ...
  bool is_aligned(const interfaces::msg::TargetDetection & detection) const
  {
  ...
  interfaces::msg::TargetDetection last_detection_;
  ...
  rclcpp::Subscription<interfaces::msg::TargetDetection>::SharedPtr detection_sub_;
