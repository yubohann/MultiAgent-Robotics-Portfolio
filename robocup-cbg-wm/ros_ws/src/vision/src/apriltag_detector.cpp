...
public:
  ...
  : Node("apriltag_detector")
  {
    ...
    detection_pub_ = create_publisher<interfaces::msg::TargetDetection>(detection_topic_, 10);
...
private:
  void image_callback(const sensor_msgs::msg::Image::SharedPtr msg)
  {
    ...
    auto detection = interfaces::msg::TargetDetection();
  ...
  void fill_pose_if_possible(
    ...
    interfaces::msg::TargetDetection & detection) const
  {
  ...
  rclcpp::Publisher<interfaces::msg::TargetDetection>::SharedPtr detection_pub_;
};
