...
def main() -> None:
    ...
    manifest = {
        "generated": [
            "docs/assets/rl/rl_training_curve_gpu.svg",
            "docs/assets/rl/rl_strategy_event_metrics.svg",
            "docs/assets/rl/rl_target_base_metrics.svg",
            "docs/assets/rl/rl_box_push_metrics.svg",
        ],
