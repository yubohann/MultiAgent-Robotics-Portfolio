...
_paper_statistics = import_module("experiments.04_paper_statistics")
fixed_tail_cvar = _paper_statistics.fixed_tail_cvar
hierarchical_bootstrap_ci = _paper_statistics.hierarchical_bootstrap_ci
holm_bonferroni = _paper_statistics.holm_bonferroni
paired_permutation_pvalue = _paper_statistics.paired_permutation_pvalue
...
def main() -> int:
    ...
    parser.add_argument("--root", type=Path, default=REPO_ROOT / "sim" / "output" / "paper" / "cbg_wm_2026")
