...
def main():
    ...
    parser.add_argument("--output-json", type=Path, default=ROOT / "sim/output/eval/strategy_contract_eval.json")
    parser.add_argument("--output-csv", type=Path, default=ROOT / "sim/output/eval/strategy_contract_eval.csv")
