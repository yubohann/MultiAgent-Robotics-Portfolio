...
def main():
    ...
    parser.add_argument("--trace", type=Path, default=ROOT / "sim/output/replay/world_model_sacflow_strict_replay_abs/strict_replay_trace.csv")
    parser.add_argument("--events", type=Path, default=ROOT / "sim/output/replay/world_model_sacflow_strict_replay_abs/strict_replay_events.jsonl")
    parser.add_argument("--summary", type=Path, default=ROOT / "sim/output/replay/world_model_sacflow_strict_replay_abs/strict_replay_summary.json")
    parser.add_argument("--episode", type=int, default=0)
    parser.add_argument("--output", type=Path, default=ROOT / "docs/assets/strict_sacflow_replay_episode0.mp4")
