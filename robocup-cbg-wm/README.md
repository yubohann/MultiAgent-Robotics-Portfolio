...
**Status.** v0.1.0 research artifact. The validated main line is the two-robot match with a 128-episode scoring run, an 8-episode strict replay audit, three-view IsaacLab media and 1v1 real-robot coverage. The 50v50 rule benchmark extends the same rules at simulation scale.
