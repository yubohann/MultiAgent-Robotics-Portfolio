...
setsid ros2 launch game_supervisor synthetic_competition.launch.py >"${log_file}" 2>&1 &
launch_pid=$!
...
sleep 1
set +e
python3 "${workspace_root}/src/game_supervisor/tools/synthetic_runtime_smoke.py"
result=$?
set -e
