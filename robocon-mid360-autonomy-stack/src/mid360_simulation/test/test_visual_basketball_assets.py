...
class VisualBasketballAssetTests(unittest.TestCase):
    def test_depth_visualizer_and_dual_launch_are_wired(self):
        ...
        visualizer = (PACKAGE_ROOT / "scripts" / "python" / "depth_visualizer.py").read_text(encoding="utf-8")
        ...
        self.assertIn("scripts/python/depth_visualizer.py", cmake)
    ...
    def test_controller_uses_staging_and_ballistic_trajectory(self):
        controller = (PACKAGE_ROOT / "scripts" / "python" / "basketball_demo_controller.py").read_text(encoding="utf-8")
    ...
    def test_quality_recorder_defaults_to_full_packet_density(self):
        runner = (PACKAGE_ROOT.parent.parent / "tools" / "runners" / "run_robocon_basketball_real_gui.sh").read_text(encoding="utf-8")
    ...
    def test_image_only_rgbd_viewer_has_no_empty_rviz_render_panel(self):
        viewer = (PACKAGE_ROOT.parent.parent / "tools" / "runners" / "run_rgbd_image_view.sh").read_text(encoding="utf-8")
