...
world_file="${3:-$workspace/install/mid360_simulation/share/mid360_simulation/worlds/indoor_competition_candidate.world}"
...
set +e
python3 "$workspace/src/mid360_simulation/scripts/python/controlled_lio_run.py" \
