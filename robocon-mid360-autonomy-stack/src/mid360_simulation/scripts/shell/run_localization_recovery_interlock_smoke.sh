...
if pgrep -f 'mid360_map_odom_anchor|game_supervisor' >/dev/null 2>&1; then
...
set +e
timeout 85s python3 "$workspace/src/mid360_simulation/scripts/python/localization_recovery_interlock_smoke.py" \
