...
world="$workspace/install/mid360_simulation/share/mid360_simulation/worlds/indoor_competition_candidate.world"
pcd="$run_dir/online_map.pcd"
metadata="$run_dir/online_map.yaml"

setsid ros2 launch mid360_simulation gazebo_fixed_map_competition.launch.py \
...
set +e
timeout 300s python3 "$workspace/src/mid360_simulation/scripts/python/fixed_map_interlock_integration.py" \
