...
fastlio_params="${FASTLIO_PARAMS:-$workspace/install/mid360_simulation/share/mid360_simulation/config/fast_lio_simulation.yaml}"
...
setsid ros2 launch mid360_simulation gazebo_mid360_candidate.launch.py \
...
replay_algorithm() {
  ...
  local tf_pid=$!
  setsid python3 "$workspace/tools/metrics/evaluate_odom_truth.py" \
