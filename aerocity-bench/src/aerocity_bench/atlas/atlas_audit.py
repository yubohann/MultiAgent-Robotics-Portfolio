"""Scientific audits for the target-independent G2I atlas."""
...
from aerocity_bench.atlas.inspection_atlas import validate_public_inspection_atlas
...
AUDIT_SCHEMA = "org.aerocity.bench.g2i-atlas-scientific-audit.v1"
    ...
    *,
    ...
    report: dict[str, Any] = {
        ...
        "remaining_gates": {
            ...
            "four_vehicle_public_g2i_l1_closure": False,
        },
    }
    return report
