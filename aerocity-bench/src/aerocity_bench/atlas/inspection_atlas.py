"""Public inspection-atlas compilation for G2I from geometry alone."""
...
from aerocity_bench.core.contracts import Pose3D
...
MISSION_SECTOR_POLICY = "g2i-budgeted-public-sector-v1"

_SAMPLING_POLICY = {
    "schema": "org.aerocity.bench.inspection-atlas-sampling-policy-public.v1",
    "policy_id": "g2i-geometric-sampling-calibration-candidate-v2",
...
_SAMPLING_POLICY_CANDIDATES = {
    ...
    "g2i-geometric-sampling-density-sparse-v1": {
        **_SAMPLING_POLICY,
        "policy_id": "g2i-geometric-sampling-density-sparse-v1",
        "footprint_spacing_fraction": 0.75,
        "calibration_status": "ablation-only",
    },
    "g2i-geometric-sampling-density-dense-v1": {
        **_SAMPLING_POLICY,
        "policy_id": "g2i-geometric-sampling-density-dense-v1",
...
def compile_inspection_atlas(
    ...
    *,
    ...
    """Compile a deterministic, target-independent G2I inspection atlas.
...
def project_inspection_atlas(
    ...
    """Create a versioned coarse/full prior for the mandatory G2I ablation.
    ...
    if prior_level not in ATLAS_PRIOR_LEVELS:
        raise ValueError(f"unsupported G2I atlas prior level: {prior_level}")
