"""Public G2I to MARVEL graph projection for an external-process diagnostic."""
...
from aerocity_bench.release.public_boundary import assert_public_fields
...
class MarvelG2IProjection:
    ...
    def from_public_reset(
        ...
        if public_task_spec.get("task_track") != "G2I":
            raise ValueError("MARVEL diagnostic requires a public G2I task")
