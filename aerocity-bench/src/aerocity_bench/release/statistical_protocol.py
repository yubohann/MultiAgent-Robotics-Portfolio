"""Ancestor-level statistical planning for the G2I comparison matrix."""
...
PROTOCOL_SCHEMA = "org.aerocity.bench.g2i-statistical-protocol.v1"
SEARCHABILITY_SCHEMA = "org.aerocity.bench.g2i-l0-searchability-calibration.v1"
REPORT_SCHEMA = "org.aerocity.bench.g2i-statistical-planning-report.v1"
...
def _validated_searchability_report(report: object) -> dict[str, Any]:
    if not isinstance(report, dict) or report.get("schema") != SEARCHABILITY_SCHEMA:
        raise ValueError("statistical planning requires a G2I searchability calibration report")
