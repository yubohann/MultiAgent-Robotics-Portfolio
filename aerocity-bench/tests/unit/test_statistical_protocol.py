...
from aerocity_bench.release.statistical_protocol import build_statistical_planning_report


def _protocol() -> dict[str, object]:
    return {
        "schema": "org.aerocity.bench.g2i-statistical-protocol.v1",
...
def _report() -> dict[str, object]:
    return {
        "schema": "org.aerocity.bench.g2i-l0-searchability-calibration.v1",
        "formal_score_eligible": False,
        "method_reports": [
