...
from aerocity_bench.core.canonical import (
    read_json,
    write_json_atomic,
    write_json_compact,
)
from aerocity_bench.core.contracts import ActionPacket, ObservationPacket, Pose3D
from aerocity_bench.generation.planning_cadence import (
    PlanningCadenceController,
    rebind_held_action,
    validate_planning_cadence,
)
from aerocity_bench.runtime.adapters import GymnasiumFleetWrapper, PettingZooParallelWrapper
from aerocity_bench.runtime.behavioral_distinctness import (
    BEHAVIOR_SUMMARY_SCHEMA,
    audit_method_panel_behavior,
    audit_method_panel_behavior_cohort,
    summarize_public_action_trace,
)
from tools.quality.audit_g2i_behavior_panel import behavior_distinct_count
...
def test_legacy_rl_wrappers_fail_closed_for_g2i(wrapper: type[object]) -> None:
    runtime = SimpleNamespace(public_task_spec={"task_track": "G2I"})
    with pytest.raises(ValueError, match="versioned G2I training wrapper"):
