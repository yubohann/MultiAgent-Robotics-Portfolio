...
G2I inspection cells.  It uses the cells' public poses and represented area,
...
starts `tools/adapters/ortools_g2i_process_adapter.py` as a separate JSONL process.
