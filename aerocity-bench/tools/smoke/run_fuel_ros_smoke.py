...
route.  A passing result is not a G1-U/G2I method integration or score.
"""
...
if __package__:
    from ..release.build_fuel_container import load_lock, verify_source
else:  # Supports direct ``python tools/smoke/run_fuel_ros_smoke.py`` execution.
