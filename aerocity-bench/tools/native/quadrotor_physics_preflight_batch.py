...
from aerocity_bench.bridge.cf2x_contract import verify_local_cf2x_asset
from aerocity_bench.bridge.host_guard import isaac_host_lock, run_guarded_process
from aerocity_bench.core.canonical import read_json, write_json_atomic
from aerocity_bench.core.errors import HostGuardError
...
def _run(args: argparse.Namespace) -> dict[str, object]:
    ...
    preflight = BENCH_ROOT / "tools" / "native" / "quadrotor_physics_preflight.py"
