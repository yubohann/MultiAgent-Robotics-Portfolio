"""Run method-independent G2I L0 public-searchability calibration.
...
REPORT_SCHEMA = "org.aerocity.bench.g2i-l0-searchability-calibration.v1"
...
def _run_record(
    ...
    *,
    ...
    runtime = L0FleetRuntime(
        ...
        city,
        private_episode,
        receipt_secret=b"g2i-method-independent-l0-calibration-v1",
    ...
    *,
    ...
    for record in records:
        ...
        if str(city.get("split")) in FORMAL_SPLITS:
            raise ValueError("G2I task calibration must not inspect a formal split")
