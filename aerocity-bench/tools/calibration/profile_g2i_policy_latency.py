"""Profile public G2I policy latency on one frozen development episode."""
...
from aerocity_bench.atlas.inspection_atlas import validate_public_mission_sector
from aerocity_bench.bridge.host_guard import foreign_isaac_processes, host_snapshot
...
from aerocity_bench.generation.ordinary_config import FORMAL_SPLITS, load_ordinary_config
from aerocity_bench.generation.targets_v3 import public_episode_projection
from aerocity_bench.runtime.baselines import BASELINES, create_baseline
from aerocity_bench.runtime.behavioral_distinctness import summarize_public_action_trace
from aerocity_bench.runtime.runtime import L0FleetRuntime

MANIFEST_SCHEMA = "org.aerocity.bench.g2i-scientific-audit-manifest.v1"
REPORT_SCHEMA = "org.aerocity.bench.g2i-public-policy-latency-profile.v1"
...
def _run_profile_replicate(
    *,
    ...
    runtime = L0FleetRuntime(
        ...
        city,
        episode,
        receipt_secret=b"g2i-public-policy-latency-profile-v1",
...
def profile_policy_latency(
    ...
    if not isinstance(manifest, dict) or manifest.get("schema") != MANIFEST_SCHEMA:
        raise ValueError("unsupported G2I calibration manifest")
    ...
    task_spec = compile_g2i_task_spec(city, config.raw["execution_contract"], config.raw["fleet"])
