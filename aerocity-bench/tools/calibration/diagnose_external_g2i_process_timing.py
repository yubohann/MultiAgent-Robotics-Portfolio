"""Attribute a non-formal external G2I planning deadline miss without Isaac.
...
from aerocity_bench.core.contracts import ObservationPacket, Pose3D
from aerocity_bench.generation.ordinary_config import load_ordinary_config
from aerocity_bench.release.public_boundary import assert_public_fields, validate_public_task_spec
from aerocity_bench.runtime.adapters import (
    ExternalProcessPlannerBridge,
    arbitrate_public_fleet_actions,
    load_external_l1_adapter_manifest,
)

REPORT_SCHEMA = "org.aerocity.bench.external-g2i-process-timing-diagnosis.v1"
...
def diagnose(
    *,
    ...
    if task_spec.get("task_track") != "G2I" or manifest.declaration.capability_profile != "G2I":
        raise ValueError("external timing diagnosis requires a G2I task and adapter")
