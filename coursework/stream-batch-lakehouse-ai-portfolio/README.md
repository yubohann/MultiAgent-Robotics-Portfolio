...
|---|---|---|
| Modern lakehouse | Kafka ingestion, Flink and Dinky processing, MinIO and Paimon storage, and Spark analysis | Kafka, Flink, Dinky, MinIO, Paimon, Spark |
...
The Docker, Maven, Kafka, Flink, Spark, and model-service workflows are lab-specific. Start with the README or report inside the lab you intend to run.
