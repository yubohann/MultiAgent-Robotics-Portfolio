...
Object detection with **YOLO26** from Ultralytics on the **VisDrone** aerial dataset, as part of my *Embedded Systems* course design at [REDACTED].
...
- **Author** Bohan Yu, student ID [REDACTED]

- **Course** Embedded Systems course design, experiments 5 and 6, 嵌入式系统课程设计实验五六

- **What it covers** the full detection workflow from dataset preparation with the VisDrone subset through YOLO26 training, validation, prediction, and ONNX export, with step-by-step lab instructions in `README.md` and screenshot evidence for every stage.
...
[README.md](README.md), the Chinese lab manual.
