...
if __name__ == '__main__':
    ...
    # Records: about 9835, one basket per record.
    # Items: about 169 product types.
    # Each line is one transaction with the purchased items.
    ...
    if args.file:
        ...
        # Default location: ../data/archive/Groceries_dataset.csv
    ...
    for itemset in list(frequent_itemsets)[:10]:
        print(set(itemset))
