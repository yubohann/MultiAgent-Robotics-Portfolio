...
class TestRecommendationAlgorithms(unittest.TestCase):
    ...
    def test_6_recommendation_algorithms_import(self):
        ...
        try:
            from recommendation_algorithms import Product, UserProfile
            print("✅ 推荐算法模块导入成功")
    ...
    def test_7_content_based_recommendation(self):
        ...
        try:
            from recommendation_algorithms import ContentBasedRecommender, UserProfile, get_sample_products
    ...
    def test_8_hybrid_recommendation(self):
        ...
        try:
            from recommendation_algorithms import HybridRecommender, UserProfile, get_sample_products
