...
class VideoPreprocessor:
    ...
    def prepare(
        ...
        *,
        ...
        # Keep part of the frames from uniform time sampling to preserve context.
        ...
        while True:
            ...
            # The reason field records why each frame was chosen.
            reason = ""
            if frame_index == 0:
                reason = "first_frame"
        ...
        for order, item in enumerate(selected, start=1):
            # Frames are stored as JPEG for direct Ollama input.
